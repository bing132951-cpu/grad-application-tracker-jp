...
- **教授与套磁**：教授资料、A/B匹配、推进分组、2027/2028申请路线与完整联系时间线；当前状态来自最新事件。
- **全国筛选档案**：全部74校可查询，默认只显示可申请、N2待确认和制度待确认项目。
- **工作记录**：按日期合并联系、制度核查、材料准备和复习活动；页面只显示日期，真实邮件时分秒仍保留在数据中。
...
未回复教授可以按“首次联系14天后、此后每30天”的规则生成下一行动；周末、日本法定节假日、盂兰盆节和年末年始会顺延。应用只记录待办，绝不自动创建或发送邮件。
